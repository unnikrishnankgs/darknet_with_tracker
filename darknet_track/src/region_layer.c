...
void delta_region_class(float *output, float *delta, int index, int class_, int classes, tree *hier, float scale, int stride, float *avg_cat)
{
    int i, n;
    if(hier){
        float pred = 1;
            ...
            for(t = 0; t < 30; ++t){
                ...
                if(truth.x > 100000 && truth.y > 100000){
                    for(n = 0; n < l.n*l.w*l.h; ++n){
                        ...
                        float p = scale*get_hierarchy_probability(l.output + class_index, l.softmax_tree, class_, l.w*l.h);
                        if(p > maxp){
                            maxp = p;
                            maxi = n;
                        }
                    ...
                    delta_region_class(l.output, l.delta, class_index, class_, l.classes, l.softmax_tree, l.class_scale, l.w*l.h, &avg_cat);
